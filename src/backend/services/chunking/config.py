...
class AppChunkingConfig:
    ...
    configs: Dict[DocumentKind, ChunkingConfig] = {
    ...
    @classmethod
    def get_config(cls, document_kind: DocumentKind) -> ChunkingConfig:
        """Retorna a configuração para um tipo específico de documento."""
        return cls.configs.get(document_kind, cls._get_default_config())

    @classmethod
    def _get_default_config(cls) -> ChunkingConfig:
